...
var _water_cooler = require("./water_cooler");

var _water_cooler2 = _interopRequireDefault(_water_cooler);
...
_water_cooler2.default.init(_socket2.default); // Brunch automatically concatenates all files in your
...
require.register("js/water_cooler.js", function(exports, require, module) {
'use strict';
...
var WaterCooler = {
  ...
  listenForChats: function listenForChats(channel) {
